 ...
 */
typedef struct hseTxOptions_tag
{
...
/* Placed in SYS_RAM / shared memory */
...
extern const hseTxOptions_t gSyncTxOptions;
...
*
* @pre          The channel must be a free channel (Use HSE_AllocateFreeChannel).
