...
typedef enum
{
    ...
    STATUS_SEC_SYSTEM_MEMORY_FAILURE       = 0x40CU,  /*!< General memory technology failure
                                                            (multibit ECC error, common fault detected) */
    STATUS_SEC_INTERNAL_MEMORY_ERROR       = 0x410U,  /*!< An internal memory error encountered while
    ...
    STATUS_SEC_FLASH_BLOCK_ERROR           = 0x413U,  /*!< Error reading, programming or erasing one of the HSM flash blocks */
    STATUS_SEC_INTERNAL_CMD_ERROR          = 0x414U,  /*!< An internal command processor error while executing a command */
    STATUS_SEC_LENGTH_ERROR                = 0x415U,  /*!< MAC/Message length out of range */
    STATUS_SEC_NO_VALID_KEY_IMG            = 0x416U,  /*!< No valid key image */
    STATUS_SEC_NO_VALID_FW                 = 0x417U,  /*!< No valid firmware */
    STATUS_SEC_NO_VALID_KEY_BLOCK          = 0x418U,  /*!< No valid key block */
    STATUS_SEC_INVALID_SECURE_COUNTER      = 0x419U,  /*!< Invalid secure counter publish value */
    STATUS_SEC_PUBLISH_KEY_NOT_ALLOWED     = 0x41AU,  /*!< Publish key image command not allowed */
    STATUS_SEC_INCORRECT_FW                = 0x41BU,  /*!< Incorrect firmware */
    STATUS_SEC_SECURE_BOOT_TIMEOUT         = 0x41CU,  /*!< Secure boot timeout */
	...
	STATUS_SEC_INVALID_CERTIFICATE         = 0x431U,  /*!< Certificate is invalid */
	STATUS_SEC_INVALID_SIGNATURE           = 0x432U,  /*!< Certificate signature is not valid */
	STATUS_SEC_INVALID_SIZE                = 0x435U,  /*!< Invalid size of key signature, message or salt */
	STATUS_SEC_FAULT_ATTACK_ERROR          = 0x436U,  /*!< Unexpected error condition during asymmetric commands or,
	 	 	 	 	 	 	 	 	 	 	 	 	 	   unexpected code execution flow or,
	 	 	 	 	 	 	 	 	 	 	 	 	 	   for DH key pair generation and compute shared secret commands,
	 	 	 	 	 	 	 	 	 	 	 	 	 	   some conditions regarding host public key value or base are not accomplished */
    ...
    STATUS_FLEXRAY_ABORTED                 = 0x1203U, /*!< FLEXRAY aborted status */
    STATUS_FLEXRAY_TX_CONFLICT_A           = 0x1204U, /*!< FLEXRAY TX conflict reported by hardware on channel A */
    STATUS_FLEXRAY_TX_CONFLICT_B           = 0x1205U, /*!< FLEXRAY TX conflict reported by hardware on channel B */
    STATUS_FLEXRAY_TX_CONFLICT_AB          = 0x1206U, /*!< FLEXRAY TX conflict reported by hardware on channel A & B */
    STATUS_FLEXRAY_FIFO_A_ERROR_CONFIG     = 0x1207U, /*!< Start index is not equal than read index into FIFO A when initialize again */
    STATUS_FLEXRAY_FIFO_B_ERROR_CONFIG     = 0x1208U, /*!< Start index is not equal than read index into FIFO B when initialize again */
    STATUS_FLEXRAY_FIFO_AB_ERROR_CONFIG    = 0x1209U, /*!< Start index is not equal than read index into FIFO A & B when initialize again */
