 ...
 */
...
#elif (defined(CPU_S32V232) || defined(CPU_S32V234))

    #define S32V23x_SERIES

    /* Specific core definitions */
    #include "common/s32_core_cm4.h"

    #if defined(CPU_S32V232)

        #define S32V232_SERIES
        /* Register definitions */
        #include "S32V232/include/S32V232.h"
        /* CPU specific feature definitions */
        #include "S32V232/include/S32V232_features.h"
...
#elif (defined(CPU_MPC5746R) || defined(CPU_MPC5745R) || defined(CPU_MPC5743R) || defined(CPU_MPC5748G) || defined(CPU_MPC5746C) || defined(CPU_MPC5741P)|| defined(CPU_MPC5742P)|| defined(CPU_MPC5743P)|| defined(CPU_MPC5744P) || defined(CPU_MPC5744B) || defined(CPU_MPC5745B) || defined(CPU_MPC5746B) || defined(CPU_MPC5744C) || defined(CPU_MPC5745C) || defined(CPU_MPC5747C) || defined(CPU_MPC5748C) || defined(CPU_MPC5746G) || defined(CPU_MPC5747G))
    ...
    #elif (defined(CPU_MPC5745R))

        #define MPC5745R_SERIES

        /* Register definitions */
        #include "MPC5745R/include/MPC5745R.h"
        /* CPU specific feature definitions */
        #include "MPC5745R/include/MPC5745R_features.h"

    #elif (defined(CPU_MPC5743R))

        #define MPC5743R_SERIES

        /* Register definitions */
        #include "MPC5743R/include/MPC5743R.h"
        /* CPU specific feature definitions */
        #include "MPC5743R/include/MPC5743R_features.h"
    ...
    #endif
#elif (defined(CPU_S32R274) || defined(CPU_S32R372) || defined(CPU_S32R294))
    ...
    #elif (defined(CPU_S32R294))

        #define S32R294_SERIES

        /* Register definitions */
        #include "S32R294/include/S32R294.h"
        #include "S32R294/include/CSE3.h"
        /* CPU specific feature definitions */
        #include "S32R294/include/S32R294_features.h"
...
#elif defined(CPU_S32G274A)

    #define S32G274A_SERIES

    /* Register definitions */
    #include "S32G274A/include/S32G274A.h"
    /* CPU specific feature definitions */
    #include "S32G274A/include/S32G274A_features.h"
    /* CPU system functions */
    #include "S32G274A/startup/system_S32G274A.h"

    /* Specific core definitions */
    #include "common/s32_core_cm7.h"

#elif defined(CPU_S32S247TV)

    #define S32S247TV_SERIES

    /* Specific core definitions */
    #include "common/s32_core_cr52.h"

    /* Register definitions */
    #include "S32S247TV/include/S32S247TV.h"
    /* CPU specific feature definitions */
    #include "S32S247TV/include/S32S247TV_features.h"

#elif (defined(CPU_MPC5777C) || defined(CPU_MPC5775E) || defined(CPU_MPC5775B))

    #define MPC577x_SERIES
    ...
    #elif (defined(CPU_MPC5775E))

        #define MPC5775E_SERIES

        /* Register definitions */
        #include "MPC5775E/include/MPC5775E.h"
        /* CPU specific feature definitions */
        #include "MPC5775E/include/MPC5775E_features.h"

    #elif (defined(CPU_MPC5775B))

        #define MPC5775B_SERIES

        /* Register definitions */
        #include "MPC5775B/include/MPC5775B.h"
        /* CPU specific feature definitions */
        #include "MPC5775B/include/MPC5775B_features.h"

    #endif

#elif defined(CPU_S32R45)

    #define S32R45_SERIES

    /* Register definitions */
    #include "S32R45/include/S32R45.h"
    /* CPU specific feature definitions */
    #include "S32R45/include/S32R45_features.h"
    /* CPU system functions */
    #include "S32R45/startup/system_S32R45.h"
    /* MODULETEST specific fake header */
    #ifdef MODULETEST
    #include "sdkmts_fake_S32R45.h"
    #endif
    ...
    /* Moduletest specific fake header */
    #ifdef MODULETEST
    #include "sdkmts_fake_s32_core_cm7.h"
    #endif
...
#ifdef SDKMTS
#include SDKMTS_FAKE_CORE
#include SDKMTS_FAKE_DEVICE
#endif
