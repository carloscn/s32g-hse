...
/*!
 * @file S32R45_FLEXTIMER.h
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32R45_FLEXTIMER
 *
...
#if !defined(S32R45_FLEXTIMER_H_)  /* Check if memory map has not been already included */
#define S32R45_FLEXTIMER_H_
...
/*!
 * @}
 */ /* end of group FLEXTIMER_Register_Masks */

/*!
 * @}
 */ /* end of group FLEXTIMER_Peripheral_Access_Layer */

#endif  /* #if !defined(S32R45_FLEXTIMER_H_) */
