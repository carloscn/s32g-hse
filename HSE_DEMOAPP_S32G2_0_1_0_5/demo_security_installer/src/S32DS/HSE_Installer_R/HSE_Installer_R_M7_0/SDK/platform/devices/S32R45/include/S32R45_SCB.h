...
**                                     RM Rev.1 RC.
**                                     2)Array name is changed from 
**                                     CLR_C__CLR_B__CLR_A to CLR.   
 ...
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32R45_SCB
 *
...
#if !defined(S32R45_SCB_H_)  /* Check if memory map has not been already included */
#define S32R45_SCB_H_
...
#endif  /* #if !defined(S32R45_SCB_H_) */
