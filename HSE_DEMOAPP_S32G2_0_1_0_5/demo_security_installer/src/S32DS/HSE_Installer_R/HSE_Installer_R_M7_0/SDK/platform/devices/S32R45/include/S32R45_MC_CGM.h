...
typedef struct {
  ...
  __I  uint32_t MUX_4_DIV_UPD_STAT;                /**< CGM Mux 4 Divider Update Status Register, offset: 0x43C */
  ...
  __I  uint32_t MUX_5_DIV_UPD_STAT;                /**< CGM Mux 5 Divider Update Status Register, offset: 0x47C */
  ...
  __I  uint32_t MUX_6_DIV_UPD_STAT;                /**< CGM Mux 6 Divider Update Status Register, offset: 0x4BC */
  ...
  __I  uint32_t MUX_9_DIV_UPD_STAT;                /**< CGM Mux 9 Divider Update Status Register, offset: 0x57C */
  ...
  __I  uint32_t MUX_10_DIV_UPD_STAT;               /**< CGM Mux 10 Divider Update Status Register, offset: 0x5BC */
  ...
  __I  uint32_t MUX_12_DIV_UPD_STAT;               /**< CGM Mux 12 Divider Update Status Register, offset: 0x63C */
  ...
  __I  uint32_t MUX_14_DIV_UPD_STAT;               /**< CGM Mux 14 Divider Update Status Register, offset: 0x6BC */
  ...
  __I  uint32_t MUX_15_DIV_UPD_STAT;               /**< CGM Mux 15 Divider Update Status Register, offset: 0x6FC */
...
/*! @{ */
#define MC_CGM_MUX_0_DC_0_PHASE_MASK             (0xFFU)
#define MC_CGM_MUX_0_DC_0_PHASE_SHIFT            (0U)
#define MC_CGM_MUX_0_DC_0_PHASE_WIDTH            (8U)
#define MC_CGM_MUX_0_DC_0_PHASE(x)               (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_0_DC_0_PHASE_SHIFT)) & MC_CGM_MUX_0_DC_0_PHASE_MASK)
...
/*! @name MUX_4_DIV_UPD_STAT - CGM Mux 4 Divider Update Status Register */
/*! @{ */
...
/*! @name MUX_5_DIV_UPD_STAT - CGM Mux 5 Divider Update Status Register */
/*! @{ */
...
/*! @name MUX_6_DIV_UPD_STAT - CGM Mux 6 Divider Update Status Register */
/*! @{ */
...
/*! @name MUX_9_DIV_UPD_STAT - CGM Mux 9 Divider Update Status Register */
/*! @{ */
...
/*! @{ */
#define MC_CGM_MUX_10_DC_0_PHASE_MASK            (0xFFU)
#define MC_CGM_MUX_10_DC_0_PHASE_SHIFT           (0U)
#define MC_CGM_MUX_10_DC_0_PHASE_WIDTH           (8U)
#define MC_CGM_MUX_10_DC_0_PHASE(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_10_DC_0_PHASE_SHIFT)) & MC_CGM_MUX_10_DC_0_PHASE_MASK)
...
/*! @name MUX_10_DIV_UPD_STAT - CGM Mux 10 Divider Update Status Register */
/*! @{ */
...
/*! @name MUX_12_DIV_UPD_STAT - CGM Mux 12 Divider Update Status Register */
/*! @{ */
...
/*! @name MUX_14_DIV_UPD_STAT - CGM Mux 14 Divider Update Status Register */
/*! @{ */
...
/*! @name MUX_15_DIV_UPD_STAT - CGM Mux 15 Divider Update Status Register */
/*! @{ */
