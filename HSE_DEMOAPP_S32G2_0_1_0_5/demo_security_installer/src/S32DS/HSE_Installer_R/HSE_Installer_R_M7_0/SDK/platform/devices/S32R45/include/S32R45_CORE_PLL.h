...
/*!
 * @file S32R45_CORE_PLL.h
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32R45_CORE_PLL
 *
...
#if !defined(S32R45_CORE_PLL_H_)  /* Check if memory map has not been already included */
#define S32R45_CORE_PLL_H_

#include "S32R45_COMMON.h"

/* ----------------------------------------------------------------------------
   -- CORE_PLL Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CORE_PLL_Peripheral_Access_Layer CORE_PLL Peripheral Access Layer
 * @{
 */

/** CORE_PLL - Size of Registers Arrays */
#define CORE_PLL_PLLODIV_COUNT                    2u

/** CORE_PLL - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t PLLODIV[CORE_PLL_PLLODIV_COUNT];   /**< PLL Output Divider, array offset: 0x80, array step: 0x4 */
} CORE_PLL_Type, *CORE_PLL_MemMapPtr;

/** Number of instances of the CORE_PLL module. */
#define CORE_PLL_INSTANCE_COUNT                  (1u)
...
/** Array initializer of CORE_PLL peripheral base addresses */
#define CORE_PLL_BASE_ADDRS                      { CORE_PLL_BASE }
/** Array initializer of CORE_PLL peripheral base pointers */
#define CORE_PLL_BASE_PTRS                       { CORE_PLL }

/* ----------------------------------------------------------------------------
   -- CORE_PLL Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CORE_PLL_Register_Masks CORE_PLL Register Masks
 * @{
 */
...
#define CORE_PLL_PLLSR_LOL_MASK                  (0x8U)
#define CORE_PLL_PLLSR_LOL_SHIFT                 (3U)
#define CORE_PLL_PLLSR_LOL_WIDTH                 (1U)
#define CORE_PLL_PLLSR_LOL(x)                    (((uint32_t)(((uint32_t)(x)) << CORE_PLL_PLLSR_LOL_SHIFT)) & CORE_PLL_PLLSR_LOL_MASK)
/*! @} */
...
/*! @{ */
#define CORE_PLL_PLLODIV_DIV_MASK                (0xFF0000U)
#define CORE_PLL_PLLODIV_DIV_SHIFT               (16U)
#define CORE_PLL_PLLODIV_DIV_WIDTH               (8U)
#define CORE_PLL_PLLODIV_DIV(x)                  (((uint32_t)(((uint32_t)(x)) << CORE_PLL_PLLODIV_DIV_SHIFT)) & CORE_PLL_PLLODIV_DIV_MASK)
#define CORE_PLL_PLLODIV_DE_MASK                 (0x80000000U)
#define CORE_PLL_PLLODIV_DE_SHIFT                (31U)
#define CORE_PLL_PLLODIV_DE_WIDTH                (1U)
#define CORE_PLL_PLLODIV_DE(x)                   (((uint32_t)(((uint32_t)(x)) << CORE_PLL_PLLODIV_DE_SHIFT)) & CORE_PLL_PLLODIV_DE_MASK)
/*! @} */

/*!
 * @}
 */ /* end of group CORE_PLL_Register_Masks */

/*!
 * @}
 */ /* end of group CORE_PLL_Peripheral_Access_Layer */

#endif  /* #if !defined(S32R45_CORE_PLL_H_) */
